...
namespace AirportAutomationApi.Controllers
{
	...
	public class FlightsController : ControllerBase
	{
		...
		public async Task<ActionResult<FlightDto>> GetFlight(int id)
		{
			...
			{
				_logger.LogError(ex, "Error getting flight with id: {id} .", id);
				throw;
			}
		}
			...
			[FromQuery] DateOnly? endDate = null)
		{
			...
			{
				_logger.LogError(ex, "Error getting flights between {startDate} and {endDate}.", startDate, endDate);
				throw;
			}
		}
		...
		/// <response code="200">Returns the created flight if successful.</response>
		...
		public async Task<IActionResult> PatchFlight(int id, [FromBody] JsonPatchDocument flightDocument)
		{
			...
			{
				_logger.LogError(ex, "Error patching flight with id: {id} .", id);
				throw;
			}
		}
